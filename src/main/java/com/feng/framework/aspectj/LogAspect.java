package com.feng.framework.aspectj;
...
import com.feng.project.monitor.operlog.service.IOperLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.feng.framework.aspectj.lang.annotation.Log)")
